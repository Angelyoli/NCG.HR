...
namespace NCG.HR.Controllers
{
    public class SystemCodesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Description,CreatedById,CreatedOn,ModifyById,ModifyOn")] SystemCode systemCode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Description,CreatedById,CreatedOn,ModifyById,ModifyOn")] SystemCode systemCode)
        {
            if (id != systemCode.Id)
            {
                return NotFound();
